                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input name="nama_supplier" id="nama_supplier" class="form-control" placeholder="Contoh: AEON Grocery" required />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="no_telp" id="no_telp" class="form-control" placeholder="Contoh: 021222333" required />
                            </div>
                        </div>
                    </div>
                    <div class="row">

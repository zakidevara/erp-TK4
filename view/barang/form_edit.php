<?php	
	...
	$barangDetail = $barang->findBarangById($id);
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input name="nama_barang" id="nama_barang" class="form-control" placeholder="Contoh: Tomat" value="<?= $barangDetail["NamaBarang"]?>" required />
                            </div>
                        </div>
                    </div>
                    <div class="row">

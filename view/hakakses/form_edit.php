<?php	
	...
	$aksesDetail = $hakakses->findAksesById($id);
...
<html>
	...
	<body>
		...
		<div class="p-5">		
            <form action="/erp-TK4/controller/hakakses/update.php" method="post" enctype="multipart/form-data">
                <div class="container">
                    <h3 class="mb-4">Form Edit Hak Akses</h3>
                    <input name="id_akses" id="id_akses" class="form-control" value="<?= $aksesDetail["IdAkses"]?>" type="hidden" required />
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="keterangan" id="keterangan" class="form-control" placeholder="Keterangan" required rows="10"><?= $aksesDetail["Keterangan"]?></textarea>
                            </div>
                        </div>
                    </div>
